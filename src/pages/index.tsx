  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Rental - Simplifying Your Carsharing Experience. Manage profiles, book vehicles, track usage, and assess performance, all in one central place."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1594291465146-1cf039f0ddc2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJzaGFyaW5nfGVufDB8fHx8MTY5Mjg0MjcyNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Rental - Simplifying Your Carsharing Experience. Manage profiles, book vehicles, track usage, and assess performance, all in one central place.`}
            </Text>
            <Box
